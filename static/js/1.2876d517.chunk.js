/*! For license information please see 1.2876d517.chunk.js.LICENSE.txt */
  ...
  [1],
  {
    ...
    17: function (e, t, n) {
      ...
      Object.defineProperty(t, "__esModule", { value: !0 }),
        (t.default = void 0);
      var i = ((r = n(86)) && r.__esModule ? r : { default: r }).default;
      t.default = i;
    },
    30: function (e, t, n) {
      "use strict";
      ...
      t.slideHandler = function (e) {
        ...
        if (r) {
          ...
          (b = w),
            ...
            (S = _(a(a({}, e), {}, { slideIndex: b }))),
            i || (m === S && (w = b), (m = S)),
            c && (y = y.concat(u(a(a({}, e), {}, { currentSlide: w })))),
            v
              ? ((O = {
                  animating: !0,
                  currentSlide: b,
                  trackStyle: j(a(a({}, e), {}, { left: m })),
                  lazyLoadedList: y,
                  targetSlide: P,
                }),
                (T = {
          ...
          return (
            ...
            (E = a(
              ...
              {},
              {
                touchObject: w,
                swipeLeft: P,
                trackStyle: k(a(a({}, t), {}, { left: P })),
              }
            )),
            Math.abs(w.curX - w.startX) < 0.8 * Math.abs(w.curY - w.startY)
              ? E
              : (w.swipeLength > 10 && ((E.swiping = !0), c(e)), E)
          );
        }
      };
      t.swipeEnd = function (e, t) {
        ...
        if (i.swipeLength > g) {
          ...
          switch (m) {
            case "left":
            case "up":
              (T = P + w(t)), (k = d ? S(t, T) : T), (O.currentDirection = 0);
              break;
            case "right":
            case "down":
              (T = P - w(t)), (k = d ? S(t, T) : T), (O.currentDirection = 1);
              break;
            default:
              k = P;
          }
      ...
      var _ = (function (e) {
        ...
        function w(e) {
          ...
          !(function (e, t) {
            ...
            j(O((t = y.call(this, e))), "listRefHandler", function (e) {
              return (t.list = e);
            }),
            ...
            j(O(t), "updateState", function (e, n, i) {
            ...
            j(O(t), "ssrInit", function () {
              ...
              var p = r.default.Children.count(t.props.children),
                ...
                g = 100 / v,
                m =
                  (-g * ((0, s.getPreClones)(h) + t.state.currentSlide) * y) /
                  100;
              return (
                t.props.centerMode && (m += (100 - (g * y) / 100) / 2),
                {
                  slideWidth: g + "%",
                  trackStyle: { width: y + "%", left: m + "%" },
                }
              );
            }),
    ...
    89: function (e, t, n) {
      (function (t) {
        ...
        e.exports = function (e, t, n) {
          ...
          function S(e) {
            var n = e - l;
            return void 0 === l || n >= t || n < 0 || (y && e - c >= o);
          }
          function w() {
            var e = p();
            if (S(e)) return O(e);
          ...
          function k() {
            ...
            if (((r = arguments), (i = this), (l = e), n)) {
              ...
              if (y) return (s = setTimeout(w, t)), g(l);
            }
          ...
          return (
            ...
            h(n) &&
              ((u = !!n.leading),
              (o = (y = "maxWait" in n) ? d(v(n.maxWait) || 0, t) : o),
              ...
              value: function () {
                for (
                  ...
                  var m = (g + 1) * d - 1,
                    ...
                    _ = this.clickHandler.bind(this, j);
                  b = b.concat(
                    r.default.createElement(
                      "li",
                      { key: g, className: k },
    ...
    93: function (e, t, n) {
      ...
      n.r(t),
        function (e) {
          ...
          var k =
            "undefined" !== typeof i.ResizeObserver ? i.ResizeObserver : O;
          t.default = k;
        }.call(this, n(43));
    },
    94: function (e, t, n) {
...
//# sourceMappingURL=1.2876d517.chunk.js.map
